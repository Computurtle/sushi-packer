...
/// <summary>
/// Made by andreyrk https://github.com/andreyrk/Unity-Sequential-Animator
/// Not part of my assessment, just used for visual effect
/// </summary>
    ...
    public IEnumerator Play()
    {
        while (true)
        {
            ...
            foreach (Animator animator in tempAnimators)
            {
                ...
                animator.SetTrigger("textAnimate");
